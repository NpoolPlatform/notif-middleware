...
[![Test](https://github.com/NpoolPlatform/notif-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/notif-middleware/actions/workflows/main.yml)
...
* make notif-middleware ```单独编译服务```
* make notif-middleware-image ```单独生成服务镜像```
