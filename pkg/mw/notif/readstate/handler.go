...
type Handler struct {
	...
	UserID  *uuid.UUID
	NotifID *uuid.UUID
	Reqs    []*readstatecrud.Req
	Conds   *readstatecrud.Conds
	Offset  int32
	Limit   int32
}
...
// nolint:gocyclo
func WithReqs(reqs []*npool.ReadStateReq) func(context.Context, *Handler) error {
	return func(ctx context.Context, h *Handler) error {
		_reqs := []*readstatecrud.Req{}
		for _, req := range reqs {
			_req := &readstatecrud.Req{}
			if req.ID != nil {
