...
import (
	...
	read1 "github.com/NpoolPlatform/notif-middleware/pkg/mw/announcement/read"
...
func (s *Server) GetReadState(ctx context.Context, in *npool.GetReadStateRequest) (*npool.GetReadStateResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "announcement/read", "crud", "Row")

	info, err := read1.GetReadState(ctx, in.GetAnnouncementID(), in.GetUserID())
	if err != nil {
...
func (s *Server) GetReadStates(ctx context.Context, in *npool.GetReadStatesRequest) (*npool.GetReadStatesResponse, error) {
	...
	span = commontracer.TraceInvoker(span, "announcement/read", "crud", "Rows")

	rows, total, err := read1.GetReadStates(ctx, in.GetConds(), in.GetOffset(), in.GetLimit())
	if err != nil {
