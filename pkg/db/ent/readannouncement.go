...
func (*ReadAnnouncement) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case readannouncement.FieldID, readannouncement.FieldCreatedAt, readannouncement.FieldUpdatedAt, readannouncement.FieldDeletedAt:
			values[i] = new(sql.NullInt64)
		case readannouncement.FieldEntID, readannouncement.FieldAppID, readannouncement.FieldUserID, readannouncement.FieldAnnouncementID:
...
func (ra *ReadAnnouncement) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", ra.EntID))
	builder.WriteString(", ")
