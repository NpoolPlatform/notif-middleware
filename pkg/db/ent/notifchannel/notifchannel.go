...
const (
	// Label holds the string label denoting the notifchannel type in the database.
	Label = "notif_channel"
	...
	// Table holds the table name of the notifchannel in the database.
	Table = "notif_channels"
)

// Columns holds all SQL columns for notifchannel fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
