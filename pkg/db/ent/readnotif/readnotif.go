...
const (
	// Label holds the string label denoting the readnotif type in the database.
	Label = "read_notif"
	...
	// Table holds the table name of the readnotif in the database.
	Table = "read_notifs"
)

// Columns holds all SQL columns for readnotif fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
