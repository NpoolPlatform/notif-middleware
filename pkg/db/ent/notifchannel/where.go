...
func ID(id uuid.UUID) predicate.NotifChannel {
...
func IDEQ(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
...
func IDIn(ids ...uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
...
func IDNotIn(ids ...uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
...
func IDGTE(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
...
func IDLT(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
...
func IDLTE(id uuid.UUID) predicate.NotifChannel {
	return predicate.NotifChannel(func(s *sql.Selector) {
